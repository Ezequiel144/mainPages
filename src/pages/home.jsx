...
import { TiTleCardPerfil } from "../components/TitleCardPerfil/TitleCardPerfil.jsx";
      ...
      <main className="main">
        <section className="main-cont">
          ...
          <section className="sec4">
            <GeneralTitle title="Tecnologias que usamos" />
            <article className="contentTech">
              <Technologi img={javaScript} />
              <Technologi img={htmlImg} />
              <Technologi img={cssImg} />
              <Technologi img={sassImg} />
              <Technologi img={nodeJsImg} />
              <Technologi img={reactImg} />
              <Technologi img={wordpressImg} />
              <Technologi img={FigmaImg} />
              <Technologi img={bootstrapImg} />
            </article>
          </section>
